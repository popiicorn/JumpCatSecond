...
public class AdMobInterstitial : MonoBehaviour
{
    ...
    public void ShowAdMobInterstitial()
    {
        ...
        else
        {
            Debug.Log("広告読み込み未完了");
            //シーン移動
            SceneManager.LoadScene("Main");// ←----------------追加
        }
    }
...
#if UNITY_ANDROID
        string adUnitId = "ca-app-pub-6736870106967218/3296000143";//ここにAndroidのインタースティシャル広告IDを入力

#elif UNITY_IPHONE
        string adUnitId = "ca-app-pub-6736870106967218/6452916025";//ここにiOSのインタースティシャル広告IDを入力
